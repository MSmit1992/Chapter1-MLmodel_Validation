...
############################################
### PART 1B - PREPARATION ANNOTATED DATA ###
############################################
...
################################################
### PART 1B - PREPARATION ACCELEROMETER DATA ###
################################################
...
##################################################################################################################### MERGE DATASETS
####################################################
### PART 2A - MERGE META DATA AND ANNOTATED DATA ###
####################################################
# Required input:   - Meta data
...
########################################################
### PART 2B - MERGE META DATA AND ACCELEROMETER DATA ###
########################################################
# Required input:   - Meta data
#                   - Accelerometer data
...
#########################################################
### PART 2C - MERGE META-ANNO DATA AND META-ACCL DATA ###
#########################################################
...
#######################################################
### PART 2A - PREPARATION COMPLETE (MERGED) DATASET ###
#######################################################

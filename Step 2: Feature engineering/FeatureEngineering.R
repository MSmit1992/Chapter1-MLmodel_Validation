...
##################################
# The raw accelerometer files contain rows that are not of interest. These first 10 rows need to be deleted.
...
fwrite(df2, "/Volumes/One Touch/PhD_Massey_Study1/Study1_072021_DataAnalysisR/Data/behaviour_data/raw_data/FE1secRaw/20210630-20210706-Scabbers.csv")
